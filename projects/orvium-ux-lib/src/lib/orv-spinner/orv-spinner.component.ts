...
@Component({
  selector: 'orv-spinner',
  templateUrl: 'orv-spinner.component.html',
  styleUrls: ['orv-spinner.component.scss'],
...
export class OrvSpinnerComponent implements OnDestroy, OnInit, OnChanges {
   ...
   * @memberof NgxSpinnerComponent
   */
  constructor(private spinnerService: OrvSpinnerService, private changeDetector: ChangeDetectorRef) {
  ...
  onInputChange(): void {
    ...
    console.log(this.spinner.class);
  }
